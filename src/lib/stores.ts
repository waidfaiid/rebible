...
// Schriftgröße des Vers-Texts in rem, global und einheitlich in allen Modi (Standard: 1.8)
export const frageFontSize = localStore('frageFontSize', 1.8);

// Schriftgröße der Referenz-Anzeige (Bibelstelle/Buch/Thema) in rem, global und einheitlich in allen Modi (Standard: 1.5)
