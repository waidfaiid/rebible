export const BUECHER = [
  { name: '1. Mose', kurz: ['Gen', 'Genesis', '1Mo', '1.Mo', '1Mose', '1 Mose'] },
  { name: '2. Mose', kurz: ['Ex', 'Exodus', '2Mo', '2.Mo', '2Mose', '2 Mose'] },
  { name: '3. Mose', kurz: ['Lev', 'Levitikus', '3Mo', '3.Mo', '3Mose', '3 Mose'] },
  { name: '4. Mose', kurz: ['Num', 'Numeri', '4Mo', '4.Mo', '4Mose', '4 Mose'] },
  { name: '5. Mose', kurz: ['Dtn', 'Deuteronomium', '5Mo', '5.Mo', '5Mose', '5 Mose', 'Deut'] },
  { name: 'Josua', kurz: ['Jos'] },
